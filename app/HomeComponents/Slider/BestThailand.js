      ...
      <div className=" flex  flex-col items-center justify-center my-5 xl:hidden lg:hidden overflow-scroll ">
        ...
        <div class="">
          <div class="flex h-80 gap-4   overflow-x-scroll hide-scrollbar">
            <Image src={img} class=""  width={400} height={400} alt="Image 1" />

            <Image src={img1} class="" width={400} height={400}  alt="Image 2" />

            <Image src={img2} class="" width={400} height={400}  alt="Image 3" />
            <Image src={img3} class="" width={400} height={400}  alt="Image 3" />
          </div>
        </div>
      </div>
    </div>
