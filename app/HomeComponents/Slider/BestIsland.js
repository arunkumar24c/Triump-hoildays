...
import img from "../../HomeComponents/assest/Maldives.png";
import img1 from "../../HomeComponents/assest/Andaman.png";
import img2 from "../../HomeComponents/assest/Seychelles.png";
import img3 from "../../HomeComponents/assest/Mauritius.png";
...
const PopularDestinationCard = (props) => {
  return (
    <div className="relative container mx-auto text-center xl:ml-11">
      <Image src={props.image} height={400} width={300} alt="" className="w-[222px] h-[301px]" />
