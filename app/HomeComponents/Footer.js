  ...
  const FaqContent = [
    {
      ...
      content: `<div class=""> 
    <div class=" ">
      <a href="" class="">International Tour Packages</a>
      <a class="pl-3">•</a>
    ...
    },
    {
      ...
      <a class="pl-3">•</a>
      <a href="" class="">Italy Tour Packages</a><a class="pl-3">•</a>
      <a href="" class="">Austria Tour Packages</a><a class="pl-3">•</a>
      ...
      <a class="pl-3">•</a><a href="" class="">Croatia Packages</a>
      <a class="pl-3">•</a>
      ...
      <a class="pl-3">•</a>
      <a href="" class="">Czech Republic Tour Packages</a><a class="pl-3">•</a>
      ...
      <a class="pl-3">•</a>
      <a href="" class="">Central Europe Tour Packages</a><a class="pl-3">•</a>
      <a href="" class="">Prague Vienna Budapest Tour Packages</a><a class="pl-3">•</a>
    ...
    <div>
      <div className="Container mx-auto pl-2 bg-black mb-4">
        ...
        <div className=" xl:hidden lg:hidden md:hidden">
          <div className="flex flex-row  justify-center items-center text-white gap-5">
            <p>
              <FiMail />
            </p>
            <p>
        ...
        <div className="text-center xl:hidden lg:hidden md:hidden text-white mt-3">
          <p className="">
            Travel Troops Global Private Ltd. © 2023 all rights
            <br /> reserved.
          </p>
        </div>
      </div>
