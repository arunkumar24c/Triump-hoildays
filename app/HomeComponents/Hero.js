    ...
    <div className="app">
      <div className="h-[100vh]  text-white flex flex-col justify-center items-center">
        ...
        <div className="mt-3 sm:mt-0 sm:ml-3.5">
          <div className="relative rounded-lg mt-3 shadow-md bg-white">
            <input
              type="text"
              placeholder="Search Destination, tours, Activities...."
              className="pl-2 py-1.5 sm:py-2 rounded-l-lg focus:outline-none w-[22rem] sm:w-[20rem] xl:w-[45rem] lg:w-[40rem] md:w-[37rem]"
            />
            <span className="absolute top-0 right-0 rounded-md  text-[gray] p-2">
      ...
      {/* button */}
      <div className="grid grid-cols-2 xl:grid-cols-4 lg:grid-cols-4 md:grid-rows-2 sm:grid-rows-2 justify-center items-center text-white">
      ...
      {/* <div className=" p-3 flex gap-[10rem] items-center justify-center">
        <div className="flex xl:gap-[7rem] md:gap-[1rem] lg:gap-[7rem] sm:gap-[1rem] flex-wrap sm:mr-2 text-white">
          <div className="flex items-center justify-center">
            <GiParachute size={35} />
            <div className="ml-2">
              <p className="text-sm sm:text-base">24000+</p>
